 ...
 *
 *     This work is free. See the LICENSE file for details.
 */
...
(function (root, factory) {
  ...
  function SocketWrench (options) {
    ...
    function sendPong () {
      if (opts.heartbeatMessage instanceof Object) {
      ...
      if (opts.connectionData) {
        ...
        for (property in connectionData) {
          if (connectionData.hasOwnProperty(property)) {
            var propertyData = connectionData[property];
            if ('[object Array]' === Object.prototype.toString.call(propertyData)) {
              propertyData.forEach (function (data) {
                parameters.push(property + '=' + data);
              });
            } else {
              parameters.push(property + '=' + propertyData);
            }
          }
        }
